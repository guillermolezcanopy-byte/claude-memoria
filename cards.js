 ...
 *
 * secs (opcional): segundos del temporizador, según el desafío.
 *   Solo lo llevan las cartas con una duración natural.
 */
...
const CARDS = [
  // ---------- Nivel 1 · Suave ----------
  { lvl: 1, secs: 30, text: "Mirá a tu pareja a los ojos durante 30 segundos sin hablar ni reírte. El que afloja primero, cumple el próximo desafío." },
  { lvl: 1, text: "Susurrale al oído tres cosas que te encantan de su cuerpo." },
  { lvl: 1, secs: 120, text: "Dale un masaje lento en los hombros y el cuello durante 2 minutos." },
  ...
  { lvl: 1, secs: 60, text: "Bailá una canción lenta bien pegados, sin importar que no haya música." },
  ...
  { lvl: 1, secs: 30, text: "Pasá un cubito de hielo por el cuello y la clavícula de tu pareja." },
  ...
  { lvl: 2, secs: 60, text: "Dale un beso de 60 segundos sin usar las manos." },
  ...
  { lvl: 2, secs: 60, text: "Elegí una zona prohibida del cuerpo de tu pareja y dedicale un minuto de besos." },
  { lvl: 2, text: "Quitate dos prendas, pero hacelo lento, como un show privado." },
  { lvl: 2, secs: 60, text: "Recostá a tu pareja y pasá tus manos por todo su cuerpo, sin tocar las zonas obvias. Todavía." },
  { lvl: 2, text: "Susurrale la cosa más atrevida que te gustaría que te haga esta noche." },
  { lvl: 2, secs: 120, text: "Dale un masaje con aceite (o crema) en la espalda y bajá todo lo que te animes." },
  ...
  { lvl: 3, secs: 120, text: "Usá solo tu boca para volver loca a tu pareja durante 2 minutos. Vos elegís dónde." },
  ...
  { lvl: 3, secs: 90, text: "Dejá que tu pareja elija una zona de tu cuerpo y la disfrute como quiera por 90 segundos." },
  ...
  { lvl: 3, secs: 120, text: "Tu pareja se queda quieta y vos tenés vía libre durante 2 minutos. Aprovechá." },
  ...
  { lvl: 4, secs: 90, text: "Sexo oral por turnos: 90 segundos cada uno, ida y vuelta, sin parar." },
  ...
  { lvl: 4, secs: 30, text: "Roleplay: inventen dos personajes en 30 segundos y métanse en el papel hasta el final." },
  ...
  { lvl: 4, secs: 300, text: "Carta comodín del infierno: el que la levantó manda absolutamente todo durante los próximos 5 minutos." },
